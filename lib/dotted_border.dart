...
class DottedOutLine extends StatelessWidget {
  static const routeName = "/dotted_outline";

  const DottedOutLine({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Dotted/Dash Border"), //appbar title
        ...
        children: [
          Container(
              ...
              child: DottedBorder(
                ...
                dashPattern: const [10,6], //dash patterns, 10 is dash width, 6 is space width
